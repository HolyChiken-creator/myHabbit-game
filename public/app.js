...
(() => {
  ...
  const CONTENT_VERSION = GAME_VERSION;
  ...
  let appLanguage = ['uk','en'].includes(localStorage.getItem(LANGUAGE_KEY)) ? localStorage.getItem(LANGUAGE_KEY) : ((navigator.language||'').toLowerCase().startsWith('en') ? 'en' : 'uk');
  const EN_TEXT = {
  ...
  Object.assign(EN_TEXT,{'Мої справи':'My tasks','Доступні':'Available','Виконані':'Completed','Виконано':'Completed','Спочатку завершіть попередній квест':'Complete the prerequisite first','Чекаємо команду':'Waiting for the team','Мої нагороди':'My rewards','Без терміну дії':'No expiry','Синхронізація':'Sync','Збережено':'Saved','Обери посильний план на сьогодні. Нагороди залишаються з тобою.':'Choose a manageable plan for today. Your rewards stay with you.','Маленькі кроки, постійний прогрес':'Small steps, lasting progress','Тут поки немає завдань.':'No tasks here yet.','100 пилу → новий стікер':'100 dust → a new sticker','Історія тимчасових нагород':'Temporary reward history','Постійна нагорода':'Permanent reward','Тимчасова можливість':'Temporary perk'});
  Object.assign(EN_TEXT,{"Мій ритм":"My streak","Відкрити":"Open","Взяти":"Start","Збережено":"Saved","Квест не знайдено":"Task not found","Профіль не знайдено":"Profile not found","Недостатньо монет":"Not enough coins","Нагороду вже отримано":"Reward already claimed","Квест додано до ваших справ":"Task added to your list","Спочатку візьміть завдання":"Start the task first","Вашу частину виконано. Чекаємо команду":"Your part is complete. Waiting for your team","Товар закінчився":"Sold out","Спільну ціль досягнуто!":"Shared goal reached!","Нагороду придбано":"Reward purchased","Предмет недоступний":"Item unavailable","Предмет у колекції":"Item added to your collection","Нових подарунків поки немає":"No new gifts yet","Подарунки рівня отримано":"Level gifts claimed","Сезонний бокс недоступний":"Seasonal box unavailable","Новий стікер!":"New sticker!","Дублікат · +10 пилу":"Duplicate · +10 dust","Колекція недоступна":"Collection unavailable","Колекція вже повна":"Collection already complete","Потрібно 100 пилу":"You need 100 dust","Новий стікер за 100 пилу":"New sticker for 100 dust","Вкажіть суму":"Enter an amount","Внесок збережено":"Contribution saved","Стікер або профіль недоступний":"Sticker or profile unavailable","На профілі вже 10 стікерів":"This profile already has 10 stickers","Теплий слід залишено":"Sticker left on the profile","Оберіть іншого учасника":"Choose another member","Немає цього стікера":"You do not have this sticker","Предмет недоступний для передачі":"This item cannot be transferred","Пакети не передаються":"Packs cannot be transferred","Нагорода недоступна":"Reward unavailable","Час дії завершився":"Expired","Невідомий тип подарунка":"Unknown gift type","Подарунок передано":"Gift sent","Вкажіть учасника та суму":"Choose a member and enter an amount","Монети передано":"Coins sent","Недостатньо прав":"Permission required","Завдання за цю дату недоступне":"Task unavailable for this date","Цей хід не створює комбінацію":"This move does not make a match","Ходи закінчилися. Можна повторити це поле.":"No moves left. You can retry this board.","Денний ліміт вичерпано":"Daily limit reached","Почати рівень":"Start level","Випадкове завдання":"Random challenge","Ланцюжок завдань":"Task chain","Особистий":"Personal","Спільний":"Team","Для двох":"For two","Лімітований":"Limited","Синхронізація":"Sync","Зʼєднання відновлено":"Connection restored","Очікуємо зʼєднання":"Waiting for a connection","Пил стікерів":"Sticker dust","Обміняти 100 пилу":"Exchange 100 dust","Виконана справа":"Completed task","Дата":"Date","Напрям":"Category","Підтверджено":"Confirmed","Так":"Yes","Ні":"No","Застелити ліжко":"Make your bed","Почати день з маленького порядку":"Start the day with a little order","Прибрати після себе":"Clean up after yourself","Залишити спільний простір чистим":"Leave the shared space clean","10 хвилин без телефона":"10 minutes without your phone","Зробити коротку паузу для уваги":"Take a short mindful break","Склянка води зранку":"A glass of water in the morning","Почати день зі склянки води":"Start the day with a glass of water","Сказати щось тепле":"Say something kind","Підтримати когось із близьких":"Encourage someone close to you","Розкласти речі по місцях":"Put things away","Повернути порядок у маленькій зоні":"Tidy up one small area","Прогулянка 20 хвилин":"A 20-minute walk","Вийти на свіже повітря та пройтися":"Get outside for some fresh air","Прочитати 10 сторінок":"Read 10 pages","Продовжити поточну книгу":"Continue your current book","Розминка 15 хвилин":"A 15-minute warm-up","Легка зарядка або мобільність":"Gentle exercise or mobility work","Навести лад на кухні":"Tidy the kitchen","Посуд, поверхні та дрібний порядок":"Dishes, surfaces and a quick tidy","Записати 3 вдячності":"Write down 3 things you are grateful for","Помітити хороше за сьогодні":"Notice the good things today","Перевірити бюджет дня":"Review today’s budget","Коротко переглянути витрати":"Take a quick look at your spending","Спільна вечеря без екранів":"Dinner together without screens","Побути разом без телефонів":"Spend time together without phones","Допомогти без нагадування":"Help without being asked","Самостійно підхопити одну справу":"Take care of one task on your own","30 хвилин навчання":"30 minutes of learning","Вивчити щось корисне для себе":"Learn something useful","Повне тренування":"A full workout","Не менше 40 хвилин активності":"At least 40 minutes of activity","Розібрати одну складну зону":"Tackle one cluttered area","Шафа, комора, стіл або балкон":"A wardrobe, pantry, desk or balcony","План на завтра":"Plan tomorrow","Скласти реалістичний список справ":"Make a realistic to-do list","Подзвонити рідним":"Call your family","Приділити час важливій людині":"Make time for someone important","Година творчості":"An hour of creativity","Малювання, музика, текст або хобі":"Drawing, music, writing or a hobby","День без зайвої покупки":"A day without impulse purchases","Не купувати нічого імпульсивного":"Avoid buying on impulse","Сімейна міні-нарада":"A family check-in","Обговорити плани й потреби команди":"Discuss your team’s plans and needs","Новий корисний рецепт":"A new healthy recipe","Приготувати щось нове та збалансоване":"Cook something new and balanced","Цифрове прибирання":"A digital clear-out","Видалити зайві файли або листи":"Delete unnecessary files or emails","Маленький сюрприз":"A little surprise","Зробити приємну несподіванку":"Give someone a pleasant surprise","Вечірня тиша 15 хвилин":"15 quiet minutes in the evening","Спокійно завершити день без екранів":"Wind down without screens","Підготувати одяг на завтра":"Prepare tomorrow’s clothes","Зменшити ранковий поспіх":"Make the morning less rushed","Винести сміття":"Take out the rubbish","Закрити просту побутову справу":"Complete a simple household task","Оновити сімейний список покупок":"Update the family shopping list","Додати потрібне та прибрати зайве":"Add what you need and remove what you don’t","Одна добра справа":"One good deed","Допомогти людині або тварині":"Help a person or an animal"});
  Object.assign(EN_TEXT,{"Очікує синхронізації":"Waiting to sync","Офлайн · дії збережені на пристрої":"Offline · actions saved on this device","Офлайн · дія очікує синхронізації":"Offline · action waiting to sync","Дію збережено. Нагорода з’явиться після синхронізації.":"Action saved. Your reward will arrive after syncing.","Конфлікт змін":"Conflicting changes","Зміни очікують на мережу":"Changes waiting for a connection","Частина ресурсів ще не готова офлайн":"Some resources are not available offline yet","Завдання на паузі":"Task paused","Інший день":"Another day","Спочатку завершіть попередній квест":"Complete the previous task first","Завдання вже виконано":"Task already completed","Усі місця зайняті":"All places are taken","Чекаємо команду":"Waiting for the team","Мої справи":"My tasks","Обери посильний план на сьогодні. Нагороди залишаються з тобою.":"Choose a manageable plan for today. Your rewards stay with you.","+ Власне завдання":"+ Custom task","Доступні":"Available","Виконані":"Completed","Будь-яка складність":"Any difficulty","Легкі":"Easy","Середні":"Medium","Складні":"Hard","Тут поки немає завдань.":"No tasks here yet.","Маленькі кроки, постійний прогрес":"Small steps, lasting progress","Збережена нагорода":"Preserved reward","Нагорода з попередньої версії":"A reward from a previous version","Права адміністратора передано":"Admin rights transferred","Рівень розпочато":"Level started","Сесію гри не знайдено":"Game session not found","Некоректні ходи":"Invalid moves","Некоректний хід":"Invalid move","Мету ще не досягнуто":"Goal not reached yet","Цей предмет поки недоступний":"This item is not available yet","Невідома дія":"Unknown action"});
  // Versioned catalog text, including descriptions, not just interface buttons.
  Object.assign(EN_TEXT,{"Зробіть разом планування вихідних":"Plan the weekend together","Виконай завдання «Зробіть разом планування вихідних» та додай короткий звіт про результат.":"Complete “Plan the weekend together” and add a brief note about the result.","Обговоріть сімейну ціль про вдячність":"Discuss a family goal about gratitude","Виконай завдання «Обговоріть сімейну ціль про вдячність» та додай короткий звіт про результат.":"Complete “Discuss a family goal about gratitude” and add a brief note about the result.","Створіть сімейну традицію навколо майбутнє":"Create a family tradition about your future","Виконай завдання «Створіть сімейну традицію навколо майбутнє» та додай короткий звіт про результат.":"Complete “Create a family tradition about your future” and add a brief note about the result.","Створіть сімейну традицію навколо спогади":"Create a family tradition around shared memories","Виконай завдання «Створіть сімейну традицію навколо спогади» та додай короткий звіт про результат.":"Complete “Create a family tradition around shared memories” and add a brief note about the result.","Створіть сімейну традицію навколо подорожі":"Create a family travel tradition","Виконай завдання «Створіть сімейну традицію навколо подорожі» та додай короткий звіт про результат.":"Complete “Create a family travel tradition” and add a brief note about the result.","Створіть сімейну традицію навколо здоров’я":"Create a healthy family tradition","Виконай завдання «Створіть сімейну традицію навколо здоров’я» та додай короткий звіт про результат.":"Complete “Create a healthy family tradition” and add a brief note about the result.","Обговоріть сімейну ціль про подорожі":"Discuss a family travel goal","Виконай завдання «Обговоріть сімейну ціль про подорожі» та додай короткий звіт про результат.":"Complete “Discuss a family travel goal” and add a brief note about the result.","Проведіть сімейний вечір із темою «відпочинок»":"Spend a relaxing evening as a family","Виконай завдання «Проведіть сімейний вечір із темою «відпочинок»» та додай короткий звіт про результат.":"Complete “Spend a relaxing evening as a family” and add a brief note about the result.","Зробіть разом настільної гри":"Play a board game together","Виконай завдання «Зробіть разом настільної гри» та додай короткий звіт про результат.":"Complete “Play a board game together” and add a brief note about the result.","Проведіть сімейний вечір із темою «вдячність»":"Spend a family evening sharing gratitude","Виконай завдання «Проведіть сімейний вечір із темою «вдячність»» та додай короткий звіт про результат.":"Complete “Spend a family evening sharing gratitude” and add a brief note about the result.","Проведіть сімейний вечір із темою «фінанси»":"Have a family evening about finances","Виконай завдання «Проведіть сімейний вечір із темою «фінанси»» та додай короткий звіт про результат.":"Complete “Have a family evening about finances” and add a brief note about the result.","Зробіть разом вечері":"Make dinner together","Виконай завдання «Зробіть разом вечері» та додай короткий звіт про результат.":"Complete “Make dinner together” and add a brief note about the result.","Заплануйте спільну активність: фільмом":"Plan a movie together","Виконай завдання «Заплануйте спільну активність: фільмом» та додай короткий звіт про результат.":"Complete “Plan a movie together” and add a brief note about the result.","Подякуй партнеру за підтримку":"Thank your partner for their support","Виконай завдання «Подякуй партнеру за підтримку» та додай короткий звіт про результат.":"Complete “Thank your partner for their support” and add a brief note about the result.","Зроби партнеру маленький сюрприз про увагу":"Give your partner a thoughtful little surprise","Виконай завдання «Зроби партнеру маленький сюрприз про увагу» та додай короткий звіт про результат.":"Complete “Give your partner a thoughtful little surprise” and add a brief note about the result.","Заплануйте спільну активність: прогулянкою":"Plan a walk together","Виконай завдання «Заплануйте спільну активність: прогулянкою» та додай короткий звіт про результат.":"Complete “Plan a walk together” and add a brief note about the result.","Проведіть розмову про увагу":"Talk about giving each other attention","Виконай завдання «Проведіть розмову про увагу» та додай короткий звіт про результат.":"Complete “Talk about giving each other attention” and add a brief note about the result.","Проведіть розмову про турботу":"Talk about caring for each other","Виконай завдання «Проведіть розмову про турботу» та додай короткий звіт про результат.":"Complete “Talk about caring for each other” and add a brief note about the result.","Проведіть розмову про спільні плани":"Talk about your shared plans","Виконай завдання «Проведіть розмову про спільні плани» та додай короткий звіт про результат.":"Complete “Talk about your shared plans” and add a brief note about the result.","Зроби партнеру маленький сюрприз про підтримку":"Give your partner a little surprise to show support","Виконай завдання «Зроби партнеру маленький сюрприз про підтримку» та додай короткий звіт про результат.":"Complete “Give your partner a little surprise to show support” and add a brief note about the result.","Створіть вечір без телефонів із прогулянкою":"Take a phone-free evening walk together","Виконай завдання «Створіть вечір без телефонів із прогулянкою» та додай короткий звіт про результат.":"Complete “Take a phone-free evening walk together” and add a brief note about the result.","Створіть вечір без телефонів із чаєм":"Share a phone-free evening over tea","Виконай завдання «Створіть вечір без телефонів із чаєм» та додай короткий звіт про результат.":"Complete “Share a phone-free evening over tea” and add a brief note about the result.","Подякуй партнеру за натхнення":"Thank your partner for inspiring you","Виконай завдання «Подякуй партнеру за натхнення» та додай короткий звіт про результат.":"Complete “Thank your partner for inspiring you” and add a brief note about the result.","Очисти коморі":"Clean the pantry","Виконай завдання «Очисти коморі» та додай короткий звіт про результат.":"Complete “Clean the pantry” and add a brief note about the result.","Організуй документи":"Organize your documents","Виконай завдання «Організуй документи» та додай короткий звіт про результат.":"Complete “Organize your documents” and add a brief note about the result.","Організуй полицю":"Organize a shelf","Виконай завдання «Організуй полицю» та додай короткий звіт про результат.":"Complete “Organize a shelf” and add a brief note about the result.","Очисти спальні":"Clean the bedroom","Виконай завдання «Очисти спальні» та додай короткий звіт про результат.":"Complete “Clean the bedroom” and add a brief note about the result.","Очисти робочій зоні":"Clean your workspace","Виконай завдання «Очисти робочій зоні» та додай короткий звіт про результат.":"Complete “Clean your workspace” and add a brief note about the result.","Полагодь дрібницю в спальні":"Fix something small in the bedroom","Виконай завдання «Полагодь дрібницю в спальні» та додай короткий звіт про результат.":"Complete “Fix something small in the bedroom” and add a brief note about the result.","Підготуй ванній до нового тижня":"Prepare the bathroom for the new week","Виконай завдання «Підготуй ванній до нового тижня» та додай короткий звіт про результат.":"Complete “Prepare the bathroom for the new week” and add a brief note about the result.","Очисти шафі":"Clean the wardrobe","Виконай завдання «Очисти шафі» та додай короткий звіт про результат.":"Complete “Clean the wardrobe” and add a brief note about the result.","Виконай 60-хвилинне тренування на ноги":"Do a 60-minute leg workout","Виконай завдання «Виконай 60-хвилинне тренування на ноги» та додай короткий звіт про результат.":"Complete “Do a 60-minute leg workout” and add a brief note about the result.","Покращ результат у вправі «баланс»":"Improve your balance","Виконай завдання «Покращ результат у вправі «баланс»» та додай короткий звіт про результат.":"Complete “Improve your balance” and add a brief note about the result.","Виконай комплекс на руки":"Do an arm workout","Виконай завдання «Виконай комплекс на руки» та додай короткий звіт про результат.":"Complete “Do an arm workout” and add a brief note about the result.","Проведи активний день із велосипедом":"Go cycling for an active day","Виконай завдання «Проведи активний день із велосипедом» та додай короткий звіт про результат.":"Complete “Go cycling for an active day” and add a brief note about the result.","Проведи активний день із йогою":"Practice yoga for an active day","Виконай завдання «Проведи активний день із йогою» та додай короткий звіт про результат.":"Complete “Practice yoga for an active day” and add a brief note about the result.","Проведи активний день із ходьбою":"Go walking for an active day","Виконай завдання «Проведи активний день із ходьбою» та додай короткий звіт про результат.":"Complete “Go walking for an active day” and add a brief note about the result.","Зроби спортивний виклик: силовими вправами":"Try a strength-training challenge","Виконай завдання «Зроби спортивний виклик: силовими вправами» та додай короткий звіт про результат.":"Complete “Try a strength-training challenge” and add a brief note about the result.","Проведи активний день із розтяжкою":"Make time for stretching","Виконай завдання «Проведи активний день із розтяжкою» та додай короткий звіт про результат.":"Complete “Make time for stretching” and add a brief note about the result.","Покращ результат у вправі «спину»":"Improve your back exercise technique","Виконай завдання «Покращ результат у вправі «спину»» та додай короткий звіт про результат.":"Complete “Improve your back exercise technique” and add a brief note about the result.","Проведи активний день із бігом":"Go running for an active day","Виконай завдання «Проведи активний день із бігом» та додай короткий звіт про результат.":"Complete “Go running for an active day” and add a brief note about the result.","Виконай 60-хвилинне тренування на баланс":"Do a 60-minute balance workout","Виконай завдання «Виконай 60-хвилинне тренування на баланс» та додай короткий звіт про результат.":"Complete “Do a 60-minute balance workout” and add a brief note about the result.","Виконай корисну звичку: відновлення":"Practice a healthy recovery habit","Виконай завдання «Виконай корисну звичку: відновлення» та додай короткий звіт про результат.":"Complete “Practice a healthy recovery habit” and add a brief note about the result.","Створи план для якісного сну":"Make a plan for better sleep","Виконай завдання «Створи план для якісного сну» та додай короткий звіт про результат.":"Complete “Make a plan for better sleep” and add a brief note about the result.","Зроби паузу для якісного сну":"Take a break to support better sleep","Виконай завдання «Зроби паузу для якісного сну» та додай короткий звіт про результат.":"Complete “Take a break to support better sleep” and add a brief note about the result.","Виконай корисну звичку: здорового харчування":"Practice a healthy eating habit","Виконай завдання «Виконай корисну звичку: здорового харчування» та додай короткий звіт про результат.":"Complete “Practice a healthy eating habit” and add a brief note about the result.","Присвяти 25 хвилин медитації":"Spend 25 minutes meditating","Виконай завдання «Присвяти 25 хвилин медитації» та додай короткий звіт про результат.":"Complete “Spend 25 minutes meditating” and add a brief note about the result.","Покращ сьогодні прогулянки":"Improve your walking routine today","Виконай завдання «Покращ сьогодні прогулянки» та додай короткий звіт про результат.":"Complete “Improve your walking routine today” and add a brief note about the result.","Присвяти 10 хвилин відновлення":"Spend 10 minutes on recovery","Виконай завдання «Присвяти 10 хвилин відновлення» та додай короткий звіт про результат.":"Complete “Spend 10 minutes on recovery” and add a brief note about the result.","Присвяти 40 хвилин гідратації":"Focus on staying hydrated over the next 40 minutes","Виконай завдання «Присвяти 40 хвилин гідратації» та додай короткий звіт про результат.":"Complete “Focus on staying hydrated over the next 40 minutes” and add a brief note about the result.","Створи план для дихальних вправ":"Make a breathing exercise plan","Виконай завдання «Створи план для дихальних вправ» та додай короткий звіт про результат.":"Complete “Make a breathing exercise plan” and add a brief note about the result.","Присвяти 60 хвилин медитації":"Spend 60 minutes meditating","Виконай завдання «Присвяти 60 хвилин медитації» та додай короткий звіт про результат.":"Complete “Spend 60 minutes meditating” and add a brief note about the result.","Розв’яжи завдання на критичне мислення":"Solve a critical-thinking problem","Виконай завдання «Розв’яжи завдання на критичне мислення» та додай короткий звіт про результат.":"Complete “Solve a critical-thinking problem” and add a brief note about the result.","Вивчи тему «історію»":"Learn about history","Виконай завдання «Вивчи тему «історію»» та додай короткий звіт про результат.":"Complete “Learn about history” and add a brief note about the result.","Розв’яжи завдання на психологію":"Solve a psychology problem","Виконай завдання «Розв’яжи завдання на психологію» та додай короткий звіт про результат.":"Complete “Solve a psychology problem” and add a brief note about the result.","Вивчи тему «психологію»":"Learn about psychology","Виконай завдання «Вивчи тему «психологію»» та додай короткий звіт про результат.":"Complete “Learn about psychology” and add a brief note about the result.","Розв’яжи завдання на науку":"Solve a science problem","Виконай завдання «Розв’яжи завдання на науку» та додай короткий звіт про результат.":"Complete “Solve a science problem” and add a brief note about the result.","Поясни іншому тему «мову»":"Explain a language topic to someone","Виконай завдання «Поясни іншому тему «мову»» та додай короткий звіт про результат.":"Complete “Explain a language topic to someone” and add a brief note about the result.","Створи короткий конспект про логіку":"Write a short summary about logic","Виконай завдання «Створи короткий конспект про логіку» та додай короткий звіт про результат.":"Complete “Write a short summary about logic” and add a brief note about the result.","Розв’яжи завдання на історію":"Solve a history problem","Виконай завдання «Розв’яжи завдання на історію» та додай короткий звіт про результат.":"Complete “Solve a history problem” and add a brief note about the result.","Прочитай 25 сторінок у жанрі «біографія»":"Read 25 pages of a biography","Виконай завдання «Прочитай 25 сторінок у жанрі «біографія»» та додай короткий звіт про результат.":"Complete “Read 25 pages of a biography” and add a brief note about the result.","Порівняй дві ідеї з книги про біографія":"Compare two ideas from a biography","Виконай завдання «Порівняй дві ідеї з книги про біографія» та додай короткий звіт про результат.":"Complete “Compare two ideas from a biography” and add a brief note about the result.","Порівняй дві ідеї з книги про наука":"Compare two ideas from a science book","Виконай завдання «Порівняй дві ідеї з книги про наука» та додай короткий звіт про результат.":"Complete “Compare two ideas from a science book” and add a brief note about the result.","Порівняй дві ідеї з книги про психологія":"Compare two ideas from a psychology book","Виконай завдання «Порівняй дві ідеї з книги про психологія» та додай короткий звіт про результат.":"Complete “Compare two ideas from a psychology book” and add a brief note about the result.","Зроби нотатку після читання про детектив":"Write a note after reading a mystery","Виконай завдання «Зроби нотатку після читання про детектив» та додай короткий звіт про результат.":"Complete “Write a note after reading a mystery” and add a brief note about the result.","Порівняй дві ідеї з книги про саморозвиток":"Compare two ideas from a self-development book","Виконай завдання «Порівняй дві ідеї з книги про саморозвиток» та додай короткий звіт про результат.":"Complete “Compare two ideas from a self-development book” and add a brief note about the result.","Прочитай розділ книги про біографія":"Read a chapter of a biography","Виконай завдання «Прочитай розділ книги про біографія» та додай короткий звіт про результат.":"Complete “Read a chapter of a biography” and add a brief note about the result.","Прочитай 5 сторінок у жанрі «бізнес»":"Read 5 pages of a business book","Виконай завдання «Прочитай 5 сторінок у жанрі «бізнес»» та додай короткий звіт про результат.":"Complete “Read 5 pages of a business book” and add a brief note about the result.","Прочитай розділ книги про бізнес":"Read a chapter of a business book","Виконай завдання «Прочитай розділ книги про бізнес» та додай короткий звіт про результат.":"Complete “Read a chapter of a business book” and add a brief note about the result.","Порекомендуй близьким книгу жанру «детектив»":"Recommend a mystery book to someone close","Виконай завдання «Порекомендуй близьким книгу жанру «детектив»» та додай короткий звіт про результат.":"Complete “Recommend a mystery book to someone close” and add a brief note about the result.","Зроби нотатку після читання про наука":"Write a note after reading about science","Виконай завдання «Зроби нотатку після читання про наука» та додай короткий звіт про результат.":"Complete “Write a note after reading about science” and add a brief note about the result.","Напиши короткий відгук на фільм жанру «комедія»":"Write a short review of a comedy film","Виконай завдання «Напиши короткий відгук на фільм жанру «комедія»» та додай короткий звіт про результат.":"Complete “Write a short review of a comedy film” and add a brief note about the result.","Проведи кіновечір із жанром «фантастика»":"Have a science-fiction movie night","Виконай завдання «Проведи кіновечір із жанром «фантастика»» та додай короткий звіт про результат.":"Complete “Have a science-fiction movie night” and add a brief note about the result.","Переглянь документальний фільм про науку":"Watch a science documentary","Виконай завдання «Переглянь документальний фільм про науку» та додай короткий звіт про результат.":"Complete “Watch a science documentary” and add a brief note about the result.","Проведи кіновечір із жанром «драма»":"Have a drama movie night","Виконай завдання «Проведи кіновечір із жанром «драма»» та додай короткий звіт про результат.":"Complete “Have a drama movie night” and add a brief note about the result.","Напиши короткий відгук на фільм жанру «драма»":"Write a short review of a drama film","Виконай завдання «Напиши короткий відгук на фільм жанру «драма»» та додай короткий звіт про результат.":"Complete “Write a short review of a drama film” and add a brief note about the result.","Переглянь документальний фільм про технології":"Watch a technology documentary","Виконай завдання «Переглянь документальний фільм про технології» та додай короткий звіт про результат.":"Complete “Watch a technology documentary” and add a brief note about the result.","Переглянь документальний фільм про спорт":"Watch a sports documentary","Виконай завдання «Переглянь документальний фільм про спорт» та додай короткий звіт про результат.":"Complete “Watch a sports documentary” and add a brief note about the result.","Відкрий для себе класичний фільм жанру «детектив»":"Discover a classic mystery film","Виконай завдання «Відкрий для себе класичний фільм жанру «детектив»» та додай короткий звіт про результат.":"Complete “Discover a classic mystery film” and add a brief note about the result.","Переглянь фільм жанру «драма»":"Watch a drama film","Виконай завдання «Переглянь фільм жанру «драма»» та додай короткий звіт про результат.":"Complete “Watch a drama film” and add a brief note about the result.","Переглянь фільм жанру «анімація»":"Watch an animated film","Виконай завдання «Переглянь фільм жанру «анімація»» та додай короткий звіт про результат.":"Complete “Watch an animated film” and add a brief note about the result.","Покажи близьким результат: короткий текст":"Share a short piece of writing with loved ones","Виконай завдання «Покажи близьким результат: короткий текст» та додай короткий звіт про результат.":"Complete “Share a short piece of writing with loved ones” and add a brief note about the result.","Зроби творчий подарунок у форматі плейлист":"Make a playlist as a creative gift","Виконай завдання «Зроби творчий подарунок у форматі плейлист» та додай короткий звіт про результат.":"Complete “Make a playlist as a creative gift” and add a brief note about the result.","Присвяти 30 хвилин створенню малюнок":"Spend 30 minutes drawing","Виконай завдання «Присвяти 30 хвилин створенню малюнок» та додай короткий звіт про результат.":"Complete “Spend 30 minutes drawing” and add a brief note about the result.","Покажи близьким результат: фото":"Share a photo with loved ones","Виконай завдання «Покажи близьким результат: фото» та додай короткий звіт про результат.":"Complete “Share a photo with loved ones” and add a brief note about the result.","Створи виріб руками на тему «подорожі»":"Make a travel-themed craft","Виконай завдання «Створи виріб руками на тему «подорожі»» та додай короткий звіт про результат.":"Complete “Make a travel-themed craft” and add a brief note about the result.","Спробуй нову техніку: виріб руками":"Try a new craft technique","Виконай завдання «Спробуй нову техніку: виріб руками» та додай короткий звіт про результат.":"Complete “Try a new craft technique” and add a brief note about the result.","Покажи близьким результат: плейлист":"Share a playlist with loved ones","Виконай завдання «Покажи близьким результат: плейлист» та додай короткий звіт про результат.":"Complete “Share a playlist with loved ones” and add a brief note about the result.","Зроби творчий подарунок у форматі фото":"Create a photo gift","Виконай завдання «Зроби творчий подарунок у форматі фото» та додай короткий звіт про результат.":"Complete “Create a photo gift” and add a brief note about the result.","Присвяти 10 хвилин створенню малюнок":"Spend 10 minutes drawing","Виконай завдання «Присвяти 10 хвилин створенню малюнок» та додай короткий звіт про результат.":"Complete “Spend 10 minutes drawing” and add a brief note about the result.","Спробуй нову техніку: фото":"Try a new photography technique","Виконай завдання «Спробуй нову техніку: фото» та додай короткий звіт про результат.":"Complete “Try a new photography technique” and add a brief note about the result.","Створи фото на тему «природа»":"Take a nature-themed photo","Виконай завдання «Створи фото на тему «природа»» та додай короткий звіт про результат.":"Complete “Take a nature-themed photo” and add a brief note about the result.","Переглянь витрати на освіту":"Review your education spending","Виконай завдання «Переглянь витрати на освіту» та додай короткий звіт про результат.":"Complete “Review your education spending” and add a brief note about the result.","Відклади кошти на подорож":"Save money for a trip","Виконай завдання «Відклади кошти на подорож» та додай короткий звіт про результат.":"Complete “Save money for a trip” and add a brief note about the result.","Відклади кошти на резерв":"Set money aside for an emergency fund","Виконай завдання «Відклади кошти на резерв» та додай короткий звіт про результат.":"Complete “Set money aside for an emergency fund” and add a brief note about the result.","Обговоріть сімейну ціль щодо подарунки":"Discuss a family gift budget","Виконай завдання «Обговоріть сімейну ціль щодо подарунки» та додай короткий звіт про результат.":"Complete “Discuss a family gift budget” and add a brief note about the result.","Створи мінібюджет для відпочинок":"Make a small leisure budget","Виконай завдання «Створи мінібюджет для відпочинок» та додай короткий звіт про результат.":"Complete “Make a small leisure budget” and add a brief note about the result.","Знайди спосіб заощадити на подорож":"Find a way to save on travel","Виконай завдання «Знайди спосіб заощадити на подорож» та додай короткий звіт про результат.":"Complete “Find a way to save on travel” and add a brief note about the result.","Знайди спосіб заощадити на подарунки":"Find a way to save on gifts","Виконай завдання «Знайди спосіб заощадити на подарунки» та додай короткий звіт про результат.":"Complete “Find a way to save on gifts” and add a brief note about the result.","Обговоріть сімейну ціль щодо відпочинок":"Discuss a family leisure budget","Виконай завдання «Обговоріть сімейну ціль щодо відпочинок» та додай короткий звіт про результат.":"Complete “Discuss a family leisure budget” and add a brief note about the result.","Знайди спосіб заощадити на резерв":"Find a way to build your emergency fund","Виконай завдання «Знайди спосіб заощадити на резерв» та додай короткий звіт про результат.":"Complete “Find a way to build your emergency fund” and add a brief note about the result.","Виконай заплановане завдання до кінця дня":"Finish a planned task by the end of the day","Виконай завдання «Виконай заплановане завдання до кінця дня» та додай короткий звіт про результат.":"Complete “Finish a planned task by the end of the day” and add a brief note about the result.","Заверши справу без відкладання":"Finish a task without putting it off","Виконай завдання «Заверши справу без відкладання» та додай короткий звіт про результат.":"Complete “Finish a task without putting it off” and add a brief note about the result.","Проведи 40 хвилин без відволікань":"Spend 40 minutes without distractions","Виконай завдання «Проведи 40 хвилин без відволікань» та додай короткий звіт про результат.":"Complete “Spend 40 minutes without distractions” and add a brief note about the result.","Підготуй план на завтра":"Prepare a plan for tomorrow","Виконай завдання «Підготуй план на завтра» та додай короткий звіт про результат.":"Complete “Prepare a plan for tomorrow” and add a brief note about the result.","Виконай заплановане завдання до вечора":"Finish a planned task by the evening","Виконай завдання «Виконай заплановане завдання до вечора» та додай короткий звіт про результат.":"Complete “Finish a planned task by the evening” and add a brief note about the result.","Виконай заплановане завдання до обіду":"Finish a planned task before lunch","Виконай завдання «Виконай заплановане завдання до обіду» та додай короткий звіт про результат.":"Complete “Finish a planned task before lunch” and add a brief note about the result.","Створи ранковий ритуал":"Create a morning routine","Виконай завдання «Створи ранковий ритуал» та додай короткий звіт про результат.":"Complete “Create a morning routine” and add a brief note about the result.","Проведи 25 хвилин без відволікань":"Spend 25 minutes without distractions","Виконай завдання «Проведи 25 хвилин без відволікань» та додай короткий звіт про результат.":"Complete “Spend 25 minutes without distractions” and add a brief note about the result."});
  Object.assign(EN_TEXT,{"Рівень":"Level","Сьогодні":"Today","Ходи":"Moves","Зібрано":"Collected","Свайпніть фішку в потрібний бік або оберіть дві сусідні фішки. Нагорода видається один раз.":"Swipe a tile or select two adjacent tiles. Each reward can only be claimed once."});
  ...
  function translateTextValue(value){
    ...
    return value
      .replace(/^Сьогодні виконано (\d+) \/ (\d+) щоденних справ$/,'Today: $1 / $2 daily tasks completed')
      .replace(/^Рівень пройдено · /,'Level complete · ')
      .replace(/^Фішка (\d+)$/,'Tile $1')
      .replace(/^Внесено (\d+) монет$/,'Contributed $1 coins')
      .replace(/^Звіт створено: (\d+) виконаних справ$/,'Report created: $1 completed tasks')
      .replace(/^Потрібен рівень (\d+)$/,'Requires level $1')
  ...
  // Retain original text so switching back also updates existing dialogs.
  const languageSources=new WeakMap();
  const ignoredTranslation=el=>el?.closest('script,style,textarea,[translate="no"],[data-no-i18n]');
  function translateNode(node){
    if(!node.parentElement||ignoredTranslation(node.parentElement))return;
    const value=node.nodeValue;if(!value?.trim())return;
    let record=languageSources.get(node);
    if(!record||value!==record.output)record={source:value,output:value};
    const output=translateTextValue(record.source);record.output=output;languageSources.set(node,record);
  ...
  function applyLanguage(root=document){
    ...
    const elements=[...(root.matches?.('[placeholder],[aria-label],[title],[alt]')?[root]:[]),...(root.querySelectorAll?.('[placeholder],[aria-label],[title],[alt]')||[])];
    for(const el of elements){if(ignoredTranslation(el))continue;
      let sources=languageSources.get(el)||{};
      for(const attr of ['placeholder','aria-label','title','alt']){if(!el.hasAttribute(attr))continue;const value=el.getAttribute(attr);let record=sources[attr];if(!record||value!==record.output)record={source:value};record.output=translateTextValue(record.source);sources[attr]=record;if(value!==record.output)el.setAttribute(attr,record.output);}
      languageSources.set(el,sources);
    }
  }
  const languageObserver=new MutationObserver(records=>{for(const record of records){if(record.type==='characterData')translateNode(record.target);else if(record.type==='attributes')applyLanguage(record.target);else for(const node of record.addedNodes)applyLanguage(node);}});
  languageObserver.observe(document.documentElement,{childList:true,subtree:true,characterData:true,attributes:true,attributeFilter:['placeholder','aria-label','title','alt']});
  ...
  const baseNavItems = [
    ...
    ['collections','▦','Колекції'],['museum','🏛️','Музей'],['family','👥','Сімʼя'],['profile','●','Профіль']
  ];
  ...
  function ensureDailyQuests(){
    state.meta=state.meta||{};const day=localDay(),fresh=dailyQuests(state,day);
    state.quests=[...(state.quests||[]).filter(q=>!q.dailyDay),...fresh];state.meta.dailyQuestDay=day;
  }
  function normalizeState(){
    ...
    for(const [index,u] of (state.users||[]).entries()){
      ...
      u.createdAt=u.createdAt||state.meta.createdAt||new Date().toISOString();u.importantDates=Array.isArray(u.importantDates)?u.importantDates:[];u.stickerInventory=u.stickerInventory||{};u.stickerUnlockHistory=Array.isArray(u.stickerUnlockHistory)?u.stickerUnlockHistory.filter(x=>x&&x.stickerId):[];u.stickerDust=Number(u.stickerDust||0);u.receivedGifts=Array.isArray(u.receivedGifts)?u.receivedGifts:[];u.activeFeatures=Array.isArray(u.activeFeatures)?u.activeFeatures:[];u.level=Math.max(1,Math.trunc(Number(u.level)||1));u.xp=Math.max(0,Number(u.xp)||0);
  ...
  function showMaintenanceScreen(message,until){
    ...
    appendMarkup(document.body,`<div id="myHabbitMaintenance" class="maintenance-screen"><div class="maintenance-shell"><img class="maintenance-art" src="/assets/maintenance-splash.webp?v=11.3.3" alt="myHabbit"><div class="maintenance-copy"><strong>${status}</strong>${safe?`<span>${safe}</span>`:''}<span>${apology}</span><button id="maintenanceRetry" class="maintenance-retry">${appLanguage==='en'?'Check again':'Перевірити ще раз'}</button></div></div></div>`);
  ...
  function addXp(u,amount,source='Активність'){
    ...
    while(u.xp>=xpRequiredForLevel(u.level)){
      ...
      state.history.unshift({icon:'⭐',text:`${escapeHtml(u.name)} досяг(ла) ${u.level} рівня`,time:'Щойно'});
    }
  ...
  function ensureCollectionAchievements(){
    for(const c of state.stickerCollections||[]){
      const milestones=[
        {pct:50,xp:150,icon:'🥈',title:`${escapeHtml(c.title)}: половина паку`,rarity:'Рідкісна'},
        {pct:100,xp:500,icon:'🏆',title:`${escapeHtml(c.title)}: повний пак`,rarity:'Епічна'}
      ];
      for(const m of milestones){const id=`collection_${c.id}_${m.pct}`;if(!state.achievements.some(a=>a.id===id))state.achievements.push({id,icon:m.icon,title:m.title,description:`Зібрати ${m.pct}% колекції «${escapeHtml(c.title)}»`,rarity:m.rarity,target:m.pct,progress:0,category:'collections',rewardXp:m.xp});}
    }
  }
  function checkCollectionMilestones(u,c){
    ...
    for(const m of [{pct:50,xp:150},{pct:100,xp:500}]){
      ...
      if(pct>=m.pct&&!u.achievements.includes(id)){unlockAchievement(u,id);addXp(u,m.xp,`ачівка «${escapeHtml(c.title)}»`);unlocked.push({id,xp:m.xp,title:a?.title||c.title});}
    }
    return unlocked;
  }
  ...
  function cleanAchievementCatalog(){const map=new Map((state.achievements||[]).filter(a=>a?.id).map(a=>[a.id,a]));for(const a of QUEST_MILESTONE_ACHIEVEMENTS)map.set(a.id,{...map.get(a.id),...a});state.achievements=[...map.values()];}

  function evaluateAchievements(u=currentUser()){
    if(!u)return [];const before=new Set(u.achievements||[]);
    // Rewards are evaluated by game actions, never by rendering a screen.
    return (u.achievements||[]).filter(id=>!before.has(id));
  }
  ...
  async function loadContentLibrary(){
    normalizeGame(state);state.contentLibrary={version:GAME_VERSION,loadedAt:new Date().toISOString()};
    safeJsonWrite(STORAGE,state);render();
  }
  function mergeContent(){normalizeGame(state);}
  async function api(path, options={}){
    const headers={'content-type':'application/json',...(options.headers||{})};
    if(auth?.token) headers.authorization=`Bearer ${auth.token}`;
    const res=await fetch(path,{cache:'no-store',...options,headers});
    const data=await res.json().catch(()=>({}));
    if(!res.ok){const error=new Error(data.error||'Помилка сервера');error.status=res.status;error.data=data;throw error;}
    return data;
  }
  function localDay(){
  ...
  function mergeUniqueActivity(primary=[],secondary=[]){const seen=new Set();return [...primary,...secondary].filter(e=>{const key=typeof e==='string'?e:(e.eventId||e.id||JSON.stringify(e));if(seen.has(key))return false;seen.add(key);return true;});}
  function mergeLocalUserProgress(localUsers=[],remoteUsers=[]){return remoteUsers;}
  function maintainDailyActionRetention(){
    const cutoff=Date.now()-35*86400000;state.history=(state.history||[]).filter(e=>!e.createdAt||new Date(e.createdAt).getTime()>=cutoff);
    state.meta=state.meta||{};state.meta.actionRetentionDay=localDay();
  }
  ...
  function pendingKey(){return 'myHabbitActionsV2:'+accountId();}
  function settingsKey(){return 'myHabbitSettingsV2:'+accountId();}
  function pendingActions(){return safeJsonRead(pendingKey(),[]);}
  function persistConfirmed(){safeJsonWrite(STORAGE,state);persistAccount();broadcastLocalState();}
  function queueDailySnapshot(){
    if(!auth?.token||auth.demo)return;
    const snapshot={id:crypto.randomUUID(),baseRevision:serverRevision,state:{family:clone(state.family),users:state.users.map(u=>({id:u.id,role:u.role,importantDates:u.importantDates,featuredAchievements:u.featuredAchievements,audioPrefs:u.audioPrefs,equipped:u.equipped,hiddenFromFamily:u.hiddenFromFamily})),quests:state.quests.map(({progress,claimedBy,...q})=>q),shop:clone(state.shop),questTemplateSettings:clone(state.questTemplateSettings||{}),profileStickers:state.profileStickers.map(st=>({id:st.id}))}};
    if(!safeJsonWrite(settingsKey(),snapshot))showToast('Зміни не збережено: недостатньо місця');
  }
  async function submitDailySnapshot(){return pushLocalStateNow();}
  let syncMessage='';
  let mutationTail=Promise.resolve();
  function mutate(task){const promise=mutationTail.then(task,task);mutationTail=promise.catch(()=>{});return promise;}
  function acceptServer(data){if(!data?.state)return;state=data.state;serverRevision=Number(data.revision??serverRevision);normalizeState();observeRewardChanges();persistConfirmed();}
  async function flushGameActions(){
    if(!auth?.token||auth.demo)return;
    const token=auth.token,key=pendingKey();
    return mutate(async()=>{
      while(auth?.token===token){const queue=safeJsonRead(key,[]),op=queue[0];if(!op)break;
        try{const result=await api('/api/family/action',{method:'POST',body:JSON.stringify(op)});if(auth?.token!==token)return;acceptServer(result);const latest=safeJsonRead(key,[]).filter(item=>item.id!==op.id);safeJsonWrite(key,latest);syncMessage=latest.length?'Очікує синхронізації':'Збережено';render();}
        catch(error){if(error.status&&error.status<500){safeJsonWrite('myHabbitRejected:'+accountId()+':'+op.id,{op,error:error.message});safeJsonWrite(key,safeJsonRead(key,[]).filter(item=>item.id!==op.id));showToast(error.message);continue;}syncMessage='Офлайн · дії збережені на пристрої';break;}
      }
    });
  }
  const activeActionKeys=new Set();
  async function runGameAction(type,fields={}){const key=accountId()+':'+type+':'+JSON.stringify(fields);if(activeActionKeys.has(key))return null;activeActionKeys.add(key);try{return await runGameActionCore(type,fields);}finally{activeActionKeys.delete(key);}}
  async function runGameActionCore(type,fields={}){
    const op={id:crypto.randomUUID(),type,...fields};
    if(auth?.demo){try{const result=applyGameAction(state,state.currentUserId,op);persistConfirmed();render();showToast(result.message);return result;}catch(error){showToast(error.message);return null;}}
    if(!auth?.token)return null;
    if(pendingActions().length){await flushGameActions();if(pendingActions().length){showToast('Попередня дія чекає на мережу');return null;}}
    if(safeJsonRead(settingsKey(),null)&&!await pushLocalStateNow())return null;
    const token=auth.token;
    return mutate(async()=>{
      if(auth?.token!==token)return null;
      const key=pendingKey();if(!safeJsonWrite(key,[...safeJsonRead(key,[]),op])){showToast('Недостатньо місця для збереження дії');return null;}
      try{const result=await api('/api/family/action',{method:'POST',body:JSON.stringify(op)});if(auth?.token!==token)return null;acceptServer(result);safeJsonWrite(key,safeJsonRead(key,[]).filter(item=>item.id!==op.id));syncMessage='Збережено';render();showToast(result.message);return result;}
      catch(error){if(error.status&&error.status<500){safeJsonWrite(key,safeJsonRead(key,[]).filter(item=>item.id!==op.id));showToast(error.message);}else {syncMessage='Офлайн · дія очікує синхронізації';showToast('Дію збережено. Нагорода з’явиться після синхронізації.');}return null;}
    });
  }
  ...
  async function pullRemote(){
    if(!auth?.token||auth.demo||safeJsonRead(settingsKey(),null))return false;
    const token=auth.token;try{const data=await api('/api/family/state');if(auth?.token!==token)return false;const changed=stateSignature(data.state)!==stateSignature(state);acceptServer(data);lastFamilyPullAt=Date.now();syncMessage=pendingActions().length?'Очікує синхронізації':'Збережено';return changed;}catch{syncMessage='Офлайн';return false;}
  }
  async function pushLocalStateNow(){
    if(!auth?.token||auth.demo)return false;
    const token=auth.token,key=settingsKey();
    return mutate(async()=>{
      const packet=safeJsonRead(key,null);if(!packet)return true;if(auth?.token!==token)return false;
  ...
  async function pullRemoteAndRender({force=false}={}){
    if(!auth?.token||auth?.demo||document.visibilityState==='hidden'||document.querySelector('.modal-backdrop')||document.activeElement?.matches('input,textarea,select'))return false;
    const now=Date.now();
  ...
  familyChannel?.addEventListener('message',event=>{
    ...
    if(!safeJsonRead(settingsKey(),null))pullRemoteAndRender({force:true}).catch(()=>{});
  });
  ...
  window.addEventListener('online',()=>{noteFamilyActivity();pushLocalStateNow().then(()=>flushGameActions()).then(()=>pullRemoteAndRender()).catch(()=>{});});
  ...
  function pwaGuideSlides(){
    ...
    return [
      `<div class="pwa-guide-visual"><span class="pwa-app-icon">✦</span><span class="pwa-guide-arrow">→</span><span class="pwa-home-icon">⌂</span></div><h2>myHabbit завжди поруч</h2><p>Додайте застосунок на пристрій, щоб відкривати його окремою іконкою, швидше запускати та переглядати збережений прогрес офлайн.</p>`,
  ...
  function go(next){route=next;history.pushState({},'',next==='landing'?'/' : `/?screen=${next}`);render();scrollTo(0,0);}
  function shell(content,title,subtitle){
    ...
    return `<div class="app-layout"><main class="main">${demoBanner}<header class="topbar"><div class="top-title"><h1>${title}</h1><p>${subtitle}</p></div><div class="top-actions"><button class="sync-status" data-action="sync-now">${escapeHtml(auth?.demo?tr('Демо','Demo'):(syncMessage||tr('Синхронізація','Sync')))}</button><label class="language-switch" title="Мова інтерфейсу"><span>🌐</span><select data-language-select><option value="uk" ${appLanguage==='uk'?'selected':''}>UA</option><option value="en" ${appLanguage==='en'?'selected':''}>EN</option></select></label><span class="coin-pill">🪙 ${format(u.coins)}</span></div></header>${content}<div class="release-label site-version-trigger" data-room-editor-trigger="version" title="Поточне оновлення">${escapeHtml(publicUpdateName)}</div></main><button class="menu-trigger global-menu-trigger" data-action="toggle-menu" aria-label="Відкрити меню" aria-expanded="false"><svg class="menu-trigger-icon" viewBox="0 0 24 24" aria-hidden="true"><path d="M5 7.5h14M5 12h14M5 16.5h14"/></svg></button><div class="menu-backdrop" data-action="close-menu"></div><aside class="dropdown-menu"><div class="menu-profile"><div class="member-initial">${(u.name||'?').slice(0,1).toUpperCase()}</div><div><strong>${escapeHtml(u.telegramUsername?'@'+u.telegramUsername:u.name)}</strong><small>${u.level} рівень · ${format(u.coins)} 🪙</small></div><button class="close" data-action="close-menu">×</button></div><nav class="nav">${nav}</nav><div class="menu-footer"><button class="btn soft" data-action="accounts">Мої профілі</button>${sessionAction}</div></aside></div>`;
  }
    ...
    return `<main class="welcome-hub">
      <section class="welcome-shell">
        ...
        <div class="welcome-content">
          ...
          <div class="welcome-trust"><span>🔒 Дані під захистом</span><span>☁ Перегляд офлайн</span><span>♡ Для всієї сімʼї</span></div>
        </div>
      </section>
    </main>`;
  }
...
function bearRigMarkup(base = '/assets/bear-rig/v1/') {
 ...
 return `<svg class="bear-rig" viewBox="180 60 900 1150" aria-hidden="true"><g class="bear-body">${BEAR_RIG.parts.filter(p=>!p.name.startsWith('head')).map(part).join('')}<g class="bear-head" style="transform-origin:${head.pivot[0]}px ${head.pivot[1]}px"><g class="bear-eyes-open">${image(head)}</g><g class="bear-eyes-closed">${image(closed)}</g></g><g class="teddy-book" style="transform-origin:625px 835px"><path d="M410 747Q520 716 625 774Q730 716 840 747L824 925Q724 895 625 946Q526 895 426 925Z" fill="#83502e" stroke="#573720" stroke-width="12"/><path d="M426 748Q530 733 621 785V926Q527 883 440 908Z" fill="#fff2cc"/><path d="M629 785Q726 733 824 748L810 908Q720 883 629 926Z" fill="#f4dfa9"/><g stroke="#b99c6d" stroke-width="6" fill="none"><path d="M454 784q78-8 137 25m-135 4q76-6 135 25m-132 4q73-4 132 25M657 809q67-29 139-25m-139 54q67-28 136-25m-136 54q64-25 133-25"/></g><path class="teddy-book-page" d="M629 785Q726 733 824 748L810 908Q720 883 629 926Z" fill="#fff5d9" style="transform-origin:629px 835px"/></g></g></svg>`;
  ...
  const ROOM_STAGE_COPY=[
    ...
    ['Перші зміни','First upgrades','У кімнаті вже з’являються перші затишні речі.','The first cozy upgrades are appearing.'],
    ['Стає затишно','Getting cozy','Тедик поступово облаштовує свій простір.','Teddy is gradually making the room his own.'],
    ['Теплий дім','Warm home','Більшість зон уже прокачано.','Most room zones are upgraded.'],
    ['Кімната мрії','Dream room','Повністю прокачаний особистий простір Тедіка.','Teddy’s fully upgraded personal space.']
  ];
  let roomStudioOpen=false;
  let roomStudioOpening=false;
  let roomStudioSlot='background';
  let roomStudioSize='normal';
  let roomStudioSkipSizeClickUntil=0;
  let roomPreviewItemId='';
  let roomStudioScrollState={tabs:0,styles:0,studio:0,shop:0,page:0};
  function setRoomStudioSize(next){
    if(!['compact','normal','expanded'].includes(next))next='normal';
    if(roomStudioSize===next)return;
    captureRoomStudioScroll();roomStudioSize=next;cozyHaptic('light');render();restoreRoomStudioScroll();
  }
  function cycleRoomStudioSize(){
    if(Date.now()<roomStudioSkipSizeClickUntil)return;
    const order=['compact','normal','expanded'];
    setRoomStudioSize(order[(order.indexOf(roomStudioSize)+1)%order.length]);
  }
  function bindRoomStudioInteractions(){
    ...
    [studio.querySelector('.room-live-tabs')].filter(Boolean).forEach(scroller=>bindEvent(scroller,'wheel',e=>{
      ...
      const delta=e.deltaX||(e.shiftKey?e.deltaY:0);if(!delta)return;
      scroller.scrollLeft+=delta;e.preventDefault();
    },{passive:false}));
    const grabber=studio.querySelector('.room-workshop-grabber');
    if(grabber){
      let startY=0,lastY=0,tracking=false;
      bindEvent(grabber,'pointerdown',e=>{tracking=true;startY=lastY=e.clientY;try{grabber.setPointerCapture(e.pointerId)}catch{}},{passive:true});
      bindEvent(grabber,'pointermove',e=>{if(tracking)lastY=e.clientY},{passive:true});
      const finish=e=>{
        if(!tracking)return;tracking=false;
        const delta=lastY-startY;
        if(Math.abs(delta)<28)return;
        roomStudioSkipSizeClickUntil=Date.now()+350;
        const order=['compact','normal','expanded'];let idx=order.indexOf(roomStudioSize);
        idx=Math.max(0,Math.min(order.length-1,idx+(delta<0?1:-1)));
        setRoomStudioSize(order[idx]);
      };
      bindEvent(grabber,'pointerup',finish,{passive:true});
      bindEvent(grabber,'pointercancel',()=>{tracking=false},{passive:true});
    }
  }
  ...
  function roomPreviewUser(u){
    ...
    return {...u,roomDecor:{...(u.roomDecor||{}),[item.slot]:item.id}};
  }
  ...
  function scrollRoomWorkshopTop(){document.querySelector('.room-live-scene')?.scrollIntoView({behavior:'smooth',block:'start'});}
  ...
  function roomRenovationProgress(u){
    ...
    const current=tiers.reduce((a,b)=>a+b,0),max=slots.length*4;
    ...
    const stage=Math.max(0,Math.min(4,Math.floor(current/Math.max(1,slots.length))));
    return {slots,upgraded,purchases,current,max,percent,stage,stageCopy:ROOM_STAGE_COPY[stage]};
  }
  ...
  function roomSourceTier(u,slot){
    const item=roomDecorItem(u,slot);return Math.max(0,Math.min(4,Number(item?.tier||0)));
  }
  function roomScene(u,next,completed,total,room){
    const progress=roomRenovationProgress(u),preview=roomStudioOpen?roomPreviewItem():null,view=preview?roomPreviewUser(u):u;
    const src={};for(const slot of Object.keys(ROOM_DECOR_SLOT_NAMES))src[slot]=roomSourceTier(view,slot);
    ...
    return `<section class="${classes}" data-room-theme-level="${progress.stage}" data-room-preview="${preview?'true':'false'}" data-room-admin="${isAdmin()?'true':'false'}" data-room-hidden="${Object.keys(src).filter(slot=>roomDecorItem(view,slot)?.empty).join(',')}" data-room-layout="${layout}" data-room-layout-version="${Number(state.roomLayoutVersion||0)}" ${attrs}>
  ...
  function roomDecorPreviewSrc(item){
    if(!item||item.empty)return '';
    const tier=Number(item.tier||0),assetSlot=item.slot==='background'?'background':item.slot;
    const replacement={ 'bookshelf-cozy':'level-1/bookshelf-perspective.png','fireplace-hitech':'level-3/fireplace-perspective.png','armchair-gothic':'level-4/armchair-perspective.png','background-hitech':'level-3/background-perspective.png' }[item.id];
    return replacement?'/assets/room-master/'+replacement:`/assets/room-master/level-${tier}/${assetSlot}.${['painting','lamp','clock'].includes(assetSlot)?'png':'webp'}`;
  }
  function roomDecorStudio(u=currentUser()){
    ...
    if(selected){
      ...
      confirm=`<div class="room-live-hint room-workshop-hint"><span>👆</span><div><strong>${tr('Торкніться предмета, щоб приміряти','Tap an item to preview')}</strong></div></div>`;
    }
    const opening=roomStudioOpening;roomStudioOpening=false;
    const sizeLabel={compact:tr('Компактна висота','Compact height'),normal:tr('Звичайна висота','Normal height'),expanded:tr('Розгорнута висота','Expanded height')}[roomStudioSize]||tr('Звичайна висота','Normal height');
    return `<section class="room-live-studio room-inline-studio" data-workshop="true" data-opening="${opening?'true':'false'}" data-sheet-size="${roomStudioSize}" aria-label="${tr('Майстерня кімнати','Room studio')}">
      <button class="room-workshop-grabber" data-action="room-workshop-size" type="button" aria-label="${sizeLabel}. ${tr('Натисніть або потягніть, щоб змінити висоту майстерні','Tap or drag to resize the workshop')}"><span></span></button>
  ...
  function dashboard(){
    ...
    <section class="room-live-layout ${roomStudioOpen?'is-editing room-sheet-'+roomStudioSize:''}"><div class="room-live-scene">${roomScene(u,next,completed,today.length,room)}</div>${roomStatusBar(u)}${roomDecorStudio(u)}</section>
    ...
    <nav class="home-links"><button data-route="shop">🎁 ${tr('Нагороди','Rewards')}</button><button data-route="collections">🎴 ${tr('Колекції','Collections')}</button><button data-route="match3">🧩 ${tr('Три в ряд','Match 3')}</button><button data-route="profile">🌿 ${tr('Мій профіль','My profile')}</button></nav>`,tr('Привіт, ','Hello, ')+escapeHtml(u.name),tr('Твій маленький крок має значення','Your small steps matter'));
  }

  let questTypeFilter='all',questDifficultyFilter='all',questViewFilter='available';
  function visibleQuests(){const u=currentUser();return state.quests.filter(q=>{const st=questStatus(state,u,q);return (!q.dailyDay||q.dailyDay===localDay())&&q.status!=='paused'&&(questViewFilter==='done'?st.done:!st.done)&&(questTypeFilter==='all'||q.type===questTypeFilter)&&(questDifficultyFilter==='all'||(q.difficulty||'normal')===questDifficultyFilter);});}
  function questCard(q){const u=currentUser(),st=questStatus(state,u,q);const type={personal:'Особистий',coop:'Спільний',pair:'Для двох',limited:'Лімітований'}[q.type]||'Особистий';return `<article class="quest"><span class="quest-icon">${escapeHtml(q.icon||'✨')}</span><div><h3>${escapeHtml(q.title)}</h3><div class="meta"><span>${escapeHtml(q.description||'')}</span><span class="tag">${type}</span>${q.prerequisiteId?'<span class="tag">Ланцюжок завдань</span>':''}</div></div><div class="quest-reward">+${num(q.rewardCoins)} 🪙 · +${num(q.rewardDiamonds??questDiamondReward(q))} 💎<small>+${num(q.rewardXp)} XP · ${skillIcon(q.skill)} +${num(q.skillXp)} XP</small><button class="btn small ${st.joined?'soft':'primary'}" data-quest="${escapeHtml(q.id)}" ${st.done||st.reason||st.waiting?'disabled':''}>${st.done?'Виконано':st.reason?escapeHtml(st.reason):st.waiting?'Чекаємо команду':st.joined?'Завершити':'Взяти'}</button></div></article>`;}
  function questsScreen(){ensureDailyQuests();const u=currentUser(),today=state.quests.filter(q=>q.dailyDay===localDay()),done=today.filter(q=>questStatus(state,u,q).done).length;return shell(`<div class="section-head"><div><h2>Мої справи</h2><small>Обери посильний план на сьогодні. Нагороди залишаються з тобою.</small></div>${isAdmin()?'<button class="btn primary" data-action="new-quest">+ Власне завдання</button>':''}</div><div class="daily-quest-summary">Сьогодні виконано ${done} / ${today.length} щоденних справ</div><div class="tabs">${[['available','Доступні'],['done','Виконані']].map(([id,label])=>`<button class="${questViewFilter===id?'active':''}" data-quest-view="${id}">${label}</button>`).join('')}</div><div class="tabs">${[['all','Усі'],['personal','Особисті'],['coop','Спільні'],['pair','Для двох'],['limited','Лімітовані']].map(([id,label])=>`<button class="${questTypeFilter===id?'active':''}" data-filter="${id}">${label}</button>`).join('')}</div><div class="tabs">${[['all','Будь-яка складність'],['easy','Легкі'],['normal','Середні'],['hard','Складні']].map(([id,label])=>`<button class="${questDifficultyFilter===id?'active':''}" data-difficulty-filter="${id}">${label}</button>`).join('')}</div><div class="quest-list" id="questList">${visibleQuests().map(questCard).join('')||'<p class="empty-soft">Тут поки немає завдань.</p>'}</div>`,'Квести','Маленькі кроки, постійний прогрес');}

  function achievementRequirement(a){
    const labels={questsCompleted:['Виконані завдання','Completed tasks'],creativeQuestsCompleted:['Творчі завдання','Creative tasks'],familyQuestsCompleted:['Сімейні завдання','Family tasks'],filmsWatched:['Переглянуті фільми','Films watched'],financeQuestsCompleted:['Фінансові завдання','Finance tasks'],healthQuestsCompleted:['Завдання для здоров’я','Health tasks'],homeQuestsCompleted:['Домашні завдання','Household tasks'],legendaryQuestsCompleted:['Легендарні завдання','Legendary tasks'],levelReached:['Досягнутий рівень','Level reached'],mindQuestsCompleted:['Завдання для розуму','Mind tasks'],pagesRead:['Прочитані сторінки','Pages read'],purchasesCompleted:['Здійснені покупки','Purchases made'],relationshipQuestsCompleted:['Завдання для стосунків','Relationship tasks'],sportQuestsCompleted:['Спортивні завдання','Exercise tasks'],streakDays:['Найкраща серія днів','Best daily streak'],coinsEarned:['Зароблені монети без бонусів досягнень','Coins earned excluding achievement bonuses'],totalXp:['Зароблений XP без бонусів досягнень','XP earned excluding achievement bonuses'],xpEarned:['Зароблений XP без бонусів досягнень','XP earned excluding achievement bonuses']};
    const label=labels[a.condition?.type];return label?tr(...label):'';
  }
  function achievementCard(a,u=currentUser()){
    const unlocked=Boolean(u?.achievements?.includes(a.id)),target=Math.max(1,num(a.condition?.value??a.target,1)),value=num(u?.achievementProgress?.[a.id]);
    const progress=unlocked?100:Math.min(100,Math.round(value/target*100)),requirement=achievementRequirement(a);
    const title=a.catalog&&requirement?requirement+' · '+format(target):translateTextValue(a.title||'Досягнення');
    const description=a.catalog&&requirement?tr('Ціль: ','Goal: ')+format(target):translateTextValue(a.description||'');
    const rarities={common:['Звичайна','Common'],uncommon:['Незвичайна','Uncommon'],rare:['Рідкісна','Rare'],epic:['Епічна','Epic'],legendary:['Легендарна','Legendary'],mythic:['Міфічна','Mythic']};
    const rarity=rarities[a.rarity]?tr(...rarities[a.rarity]):translateTextValue(a.rarity||'Звичайна');
    const status=unlocked?tr('Відкрито','Unlocked'):format(Math.min(value,target))+' / '+format(target);
    return '<article class="achievement-card '+(unlocked?'unlocked':'locked')+'"><div class="achievement-icon">'+achievementIconHtml(a)+'</div><div><span class="rarity">'+escapeHtml(rarity)+'</span><h3>'+escapeHtml(title)+'</h3><p>'+escapeHtml(description)+'</p><div class="progress" role="progressbar" aria-label="'+escapeHtml(title)+'" aria-valuemin="0" aria-valuemax="100" aria-valuenow="'+progress+'"><i style="width:'+progress+'%"></i></div><small>'+escapeHtml(status)+'</small>'+(a.archived?'<small>'+tr('Збережено з попередньої версії','Preserved from a previous version')+'</small>':'')+'</div></article>';
  }

  function unlockAchievement(u,id){if(!u||u.achievements.includes(id))return false;u.achievements.push(id);const a=state.achievements.find(x=>x.id===id);u.activity.unshift(`Отримано ачивку «${a?.title||id}»`);state.history.unshift({icon:a?.icon||'🏆',text:`${escapeHtml(u.name)} отримав(ла) «${a?.title||'нову ачивку'}»`,time:'Щойно'});if(u.id===state.currentUserId){announcedAchievements.add(id);queueAchievementToast(a||{id,icon:'🏆',title:id,rarity:'Звичайна'});}return true;}
  function evaluateReferralAchievements(u){
    ...
    for(const [need,id] of levels){const a=state.achievements.find(x=>x.id===id);if(a)a.progress=Math.max(Number(u?.achievementProgress?.[a.id]||0),count);if(count>=need)unlockAchievement(u,id);}
    const referred=state.users.filter(x=>x.invitedBy===u.id);const referralXp=referred.reduce((n,x)=>n+Number(x.totalXpEarned||0),0);const bestStreak=referred.reduce((n,x)=>Math.max(n,Number(x.streak||0)),0);const referralGifts=(state.giftHistory||[]).filter(g=>referred.some(x=>x.id===g.fromId)&&referred.some(x=>x.id===g.toId)).length;
  ...
  function achievementsScreen(){const u=currentUser();const list=tidyAchievements(u);return shell(`<div class="achievement-list-head"><button class="btn soft small" data-route="museum">← До музею</button><div><h2>Усі досягнення</h2><small class="meta">Відкрито ${tidyAchievements(u,true).length} · повний список від першого до наступних цілей</small></div></div><div class="achievement-list">${list.map(a=>achievementCard(a,u)).join('')}</div>`,`Досягнення`,`Повний список зберігається всередині Музею.`);}
  ...
  async function chooseRoomTheme(level){
    const u=currentUser(),n=Math.max(0,Math.min(4,Math.trunc(Number(level)||0)));if(!u)return;
    const owned=roomThemeOwned(u,n);cozyHaptic('medium');
    const result=await runGameAction(owned?'room-theme-equip':'room-theme-buy',{level:n});
    if(result){render();setTimeout(()=>document.querySelector('.room-theme-shop')?.scrollIntoView({block:'start',behavior:'smooth'}),40);}
  }
  function roomThemeShopMarkup(u=currentUser()){
    if(!u)return '';
    const active=activeRoomThemeLevel(u),balance=Number(u.diamonds||0);
    const cards=ROOM_THEME_PACKS.map(pack=>{
      const level=Number(pack.level),owned=roomThemeOwned(u,level),current=active===level,prevOk=level===0||roomThemeOwned(u,level-1),affordable=balance>=Number(pack.price||0);
      const locked=!owned&&!prevOk;
      const label=current?tr('Встановлено','Equipped'):owned?tr('Встановити','Equip'):locked?tr('Спочатку попередній рівень','Unlock previous level'):affordable?`${tr('Купити','Buy')} · ${pack.price} 💎`:`${tr('Потрібно','Need')} ${Math.max(0,Number(pack.price||0)-balance)} 💎`;
      return `<article class="room-theme-card level-${level} ${current?'is-active':''} ${owned?'is-owned':''} ${locked?'is-locked':''}"><div class="room-theme-preview"><img src="/assets/room-master/level-${level}/background.webp" alt="" loading="lazy"><span>${pack.icon}</span><b>${level}</b></div><div class="room-theme-card-copy"><small>${tr('Рівень кімнати','Room level')} ${level}</small><h3>${escapeHtml(pack.title)}</h3><p>${escapeHtml(pack.subtitle)}</p><div class="room-theme-price">${level===0?tr('Стартовий','Starter'):`${pack.price} 💎`}</div></div><button class="btn ${current?'soft':'primary'}" data-action="room-theme-select" data-level="${level}" ${(current||locked||(!owned&&!affordable))?'disabled':''}>${label}</button></article>`;
    }).join('');
    return `<section class="room-theme-shop" id="roomThemeShop"><div class="room-theme-shop-head"><div><span class="eyebrow">${tr('Кімната Тедіка','Teddy room')}</span><h2>${tr('Прокачка дому за діаманти','Home upgrades with diamonds')}</h2><p>${tr('Купуйте цілісні рівні кімнати: фон і весь комплект меблів змінюються разом.','Buy complete room levels: background and furniture upgrade together.')}</p></div><strong>💎 ${format(balance)}</strong></div><div class="room-theme-grid">${cards}</div></section>`;
  }
  function shopScreen(){
  ...
  function openAlbum(collectionId,highlightId=''){document.querySelector('[data-album-root]')?.remove();appendMarkup(document.body,albumMarkup(collectionId,highlightId));const root=document.querySelector('[data-album-root]');hydrateLottieStickers(root||document);requestAnimationFrame(()=>root?.classList.add('open'));bindAlbum();}
  ...
  function museumScreen(){
    ...
    const museumAchievementPreview=achievements.slice(0,4);const achievementCards=museumAchievementPreview.length?museumAchievementPreview.map(a=>achievementCard(a,u)).join(''):'<div class="empty-soft">Перше досягнення з’явиться після виконаного завдання.</div>';
    ...
    <section class="card museum-section museum-achievements"><div class="section-head"><div><h2>Досягнення</h2><small>${achievements.length} відкрито</small></div><button class="btn soft small" data-route="achievements">Усі досягнення →</button></div><div class="achievement-grid compact-achievements museum-achievement-preview">${achievementCards}</div></section>
  ...
  async function transferFamilyCoins(){const to=document.getElementById('coinTransferRecipient')?.value,amount=Math.floor(Number(document.getElementById('coinTransferAmount')?.value||0));return runGameAction('coin-transfer',{to,amount});}

  function activeFeaturesOf(u){return (u?.activeFeatures||[]).filter(f=>!f.expiresAt||Number(f.expiresAt)>Date.now()).slice().sort((a,b)=>Number(a.expiresAt||Infinity)-Number(b.expiresAt||Infinity));}
  function featureDaysLeft(f){return Math.max(1,Math.ceil((Number(f.expiresAt||0)-Date.now())/86400000));}
  function activeFeaturesBlock(u,own){const list=activeFeaturesOf(u),expired=(u?.activeFeatures||[]).filter(f=>f.expiresAt&&Number(f.expiresAt)<=Date.now());return `<details class="cozy-fold active-features-fold" open><summary><span>✨</span><strong>Мої нагороди</strong><small>${list.length}</small></summary><div class="fold-body active-feature-grid">${list.map(f=>`<article class="active-feature-card"><span>${escapeHtml(f.icon||'🎁')}</span><div><strong>${escapeHtml(f.title)}</strong><small>${escapeHtml(f.description||'')} · ${f.expiresAt?'ще '+featureDaysLeft(f)+' дн.':'Без терміну дії'}</small></div></article>`).join('')||'<p>Нагород поки немає.</p>'}${expired.length?`<details><summary>Історія тимчасових нагород · ${expired.length}</summary>${expired.map(f=>`<p>${escapeHtml(f.title)} · термін дії завершено</p>`).join('')}</details>`:''}</div></details>`;}
  ...
  function adminMemberRow(u){
    ...
    return `<article class="admin-row"><span class="avatar">${u.avatar}</span><div><strong translate="no">${escapeHtml(u.name)}</strong><small>${format(u.coins)} 🪙 · ${format(u.diamonds||0)} 💎 · ${roleLabel}${u.hiddenFromFamily?' · приховано':''}</small></div><div class="admin-actions">${privacy}${transfer}${action}</div></article>`;
  }
  ...
  const CozyCompanion = (()=>{
    ...
    function highlight(selector){
      ...
      appendMarkup(document.body,'<div class="cozy-tour-overlay" aria-hidden="true"></div>');
    ...
    function present(item){
      ...
      showBubble(`${escapeHtml(item.title)} · ${pos}`,item.text,`${stepIndex>1?'<button data-cozy-action="prev">Назад</button>':''}<button data-cozy-action="skip">Пропустити</button><button class="primary" data-cozy-action="next">${stepIndex===tour.length?'Готово':'Далі'}</button>`);
    }
  ...
  function render(){
    ...
    try{
      app.innerHTML=safeMarkup((screens[route]||landing)()); applyTheme(); bind(); applyLanguage(app); hydrateLottieStickers(app); CozyCompanion.afterRender();
    }catch(error){
  ...
  function bindEvent(node,type,handler,options){let handlers=boundEvents.get(node);if(!handlers){handlers=new Map();boundEvents.set(node,handlers);}const previous=handlers.get(type);if(previous)node.removeEventListener(type,previous);handlers.set(type,handler);node.addEventListener(type,handler,options);}
  let modalReturnFocus=null;
  function prepareModal(backdrop){if(backdrop.dataset.accessible)return;backdrop.dataset.accessible='1';modalReturnFocus=document.activeElement;const dialog=backdrop.querySelector('.modal')||backdrop;const duration=dialog.querySelector('#sDurationDays');if(duration){let kind=dialog.querySelector('#sRewardKind');if(!kind){kind=document.createElement('select');kind.id='sRewardKind';kind.setAttribute('aria-label','Тип нагороди');kind.innerHTML='<option value="permanent">Постійна нагорода</option><option value="timed">Тимчасова можливість</option>';duration.before(kind);}const itemId=dialog.querySelector('[data-shop-id]')?.dataset.shopId;kind.value=state.shop.find(i=>i.id===itemId)?.rewardKind||'permanent';}dialog.setAttribute('role','dialog');dialog.setAttribute('aria-modal','true');dialog.tabIndex=-1;const title=dialog.querySelector('h2');if(title){title.id=title.id||'modal-title-'+crypto.randomUUID();dialog.setAttribute('aria-labelledby',title.id);}dialog.focus();dialog.addEventListener('keydown',e=>{if(e.key==='Escape'){backdrop.remove();modalReturnFocus?.focus?.();}if(e.key==='Tab'){const nodes=[...dialog.querySelectorAll('button:not([disabled]),input,select,textarea,a[href],[tabindex="0"]')].filter(n=>n.getClientRects().length);if(!nodes.length){e.preventDefault();return;}if(e.shiftKey&&(document.activeElement===nodes[0]||document.activeElement===dialog)){e.preventDefault();nodes.at(-1).focus();}else if(!e.shiftKey&&document.activeElement===nodes.at(-1)){e.preventDefault();nodes[0].focus();}}});}
  function safeMarkup(markup){const doc=new DOMParser().parseFromString(String(markup),'text/html');doc.querySelectorAll('script,iframe,object,embed,base,meta,link,form').forEach(el=>el.remove());for(const el of doc.body.querySelectorAll('*'))for(const attr of [...el.attributes]){const name=attr.name.toLowerCase(),value=attr.value.trim();if(name.startsWith('on')||name==='srcdoc'||(['href','src','xlink:href','action','formaction'].includes(name)&&/^(?:javascript|vbscript|data:text\/html):/i.test(value))||(name==='style'&&/url\s*\(|expression\s*\(/i.test(value)))el.removeAttribute(attr.name);}return doc.body.innerHTML;}
  function appendMarkup(target,markup){target.insertAdjacentHTML('beforeend',safeMarkup(markup));}

  function bind(){

    document.querySelectorAll('button,[data-route],[role=button]').forEach(el=>{if(el.dataset.cozySoundBound)return;el.dataset.cozySoundBound='1';bindEvent(el,'pointerdown',()=>playCozySound(el.matches('[data-route],.menu-button,.hamburger')?'menu':'tap','full'),{passive:true});});
    document.querySelectorAll('[data-route]').forEach(el=>bindEvent(el,'click',()=>{document.body.classList.remove('menu-open');go(el.dataset.route);}));
    document.querySelectorAll('[data-language-select]').forEach(el=>bindEvent(el,'change',()=>{appLanguage=el.value==='en'?'en':'uk';localStorage.setItem(LANGUAGE_KEY,appLanguage);render();applyLanguage(document);}));
    document.querySelectorAll('[data-action]').forEach(el=>bindEvent(el,'click',()=>action(el.dataset.action,el)));
    document.querySelectorAll('details[data-admin-module]').forEach(panel=>bindEvent(panel,'toggle',()=>{if(!panel.open)return;document.querySelectorAll('details[data-admin-module]').forEach(other=>{if(other!==panel)other.open=false;});localStorage.setItem(ADMIN_PANEL_SECTION_KEY,panel.dataset.adminModule||'');}));
    document.querySelectorAll('[data-quest]').forEach(el=>bindEvent(el,'click',()=>handleQuest(el.dataset.quest)));
    document.querySelectorAll('[data-shop]').forEach(el=>bindEvent(el,'click',()=>handleShop(el.dataset.shop)));
    document.querySelectorAll('[data-account-id]').forEach(x=>bindEvent(x,'click',()=>switchAccount(x.dataset.accountId)));
    const accountImport=document.getElementById('accountImportFile'); if(accountImport)bindEvent(accountImport,'change',e=>importAccountFile(e.target.files?.[0]));
    document.querySelectorAll('[data-buy]').forEach(el=>bindEvent(el,'click',()=>handleShop(el.dataset.buy)));
    document.querySelectorAll('[data-open-box]').forEach(el=>bindEvent(el,'click',()=>openStickerBox(el.dataset.openBox)));
    ...
    document.querySelectorAll('[data-member]').forEach(el=>bindEvent(el,'click',()=>{app.innerHTML=safeMarkup(profileScreen(el.dataset.member));bind();scrollTo(0,0)}));
    document.querySelectorAll('[data-admin-toggle-quest]').forEach(el=>bindEvent(el,'click',()=>{const q=state.quests.find(x=>x.id===el.dataset.adminToggleQuest);if(q){q.status=q.status==='active'?'paused':'active';if(q.catalog){state.questOverrides=state.questOverrides||{};state.questOverrides[q.id]={...(state.questOverrides[q.id]||{}),status:q.status};}save();render();}}));
    document.querySelectorAll('[data-admin-delete-quest]').forEach(el=>bindEvent(el,'click',()=>{state.quests=state.quests.filter(x=>x.id!==el.dataset.adminDeleteQuest);save();render();showToast('Завдання видалено');}));
    document.querySelectorAll('[data-admin-delete-shop]').forEach(el=>bindEvent(el,'click',()=>{state.shop=state.shop.filter(x=>x.id!==el.dataset.adminDeleteShop);save();render();showToast('Позицію видалено');}));
    document.querySelectorAll('[data-edit-quest]').forEach(el=>bindEvent(el,'click',()=>openNamedModal(`edit-quest:${el.dataset.editQuest}`)));
    document.querySelectorAll('[data-edit-template]').forEach(el=>bindEvent(el,'click',()=>openNamedModal(`edit-template:${el.dataset.editTemplate}`)));
    document.querySelectorAll('[data-toggle-template]').forEach(el=>bindEvent(el,'click',()=>{const key=el.dataset.toggleTemplate,o=questTemplateState(key);o.enabled=o.enabled===false;state.questTemplateSettings[key]=o;state.meta.dailyQuestDay='';save();render();showToast(o.enabled===false?'Шаблон прибрано':'Шаблон повернуто');}));
    document.querySelectorAll('[data-edit-shop]').forEach(el=>bindEvent(el,'click',()=>openNamedModal(`edit-shop:${el.dataset.editShop}`)));
    document.querySelectorAll('[data-add-ready-shop]').forEach(el=>bindEvent(el,'click',()=>{const row=el.closest('.ready-product'),qty=Math.max(1,Number(row?.querySelector('input')?.value||1)),x=READY_SHOP_CATALOG.find(y=>y[0]===el.dataset.addReadyShop);if(!x)return;const existing=state.shop.find(i=>i.catalogId===x[0]);if(existing)existing.stock=Number(existing.stock||0)+qty;else state.shop.unshift({id:crypto.randomUUID(),catalogId:x[0],icon:x[1],title:x[2],description:x[3],price:x[4],stock:qty,type:x[5],fund:0,source:'catalog'});save();render();showToast(`Додано: ${x[2]} ×${qty}`);}));

    document.querySelectorAll('[data-reset-user]').forEach(el=>bindEvent(el,'click',()=>openResetUserDialog(el.dataset.resetUser)));
    document.querySelectorAll('[data-kick-user]').forEach(el=>bindEvent(el,'click',()=>{appendMarkup(document.body,modal(`kick-user:${el.dataset.kickUser}`));bindModal();}));
    document.querySelectorAll('[data-toggle-admin-hidden]').forEach(el=>bindEvent(el,'click',()=>toggleAdminFamilyVisibility(el.dataset.toggleAdminHidden)));
    document.querySelectorAll('[data-transfer-admin]').forEach(el=>bindEvent(el,'click',()=>transferFamilyAdminRights(el.dataset.transferAdmin)));
    document.querySelectorAll('[data-stock]').forEach(el=>bindEvent(el,'click',()=>{const i=state.shop.find(x=>x.id===el.dataset.stock);if(i){i.stock=Math.max(0,i.stock+Number(el.dataset.delta));save();render();}}));
    document.getElementById('shopImportFile')?.addEventListener('change',importShopFile);
    document.querySelectorAll('[data-filter],[data-difficulty-filter],[data-quest-view]').forEach(el=>bindEvent(el,'click',()=>{if(el.dataset.filter)questTypeFilter=el.dataset.filter;if(el.dataset.difficultyFilter)questDifficultyFilter=el.dataset.difficultyFilter;if(el.dataset.questView)questViewFilter=el.dataset.questView;render();}));

    document.querySelectorAll('[data-auth-tab]').forEach(el=>bindEvent(el,'click',()=>{authMode=el.dataset.authTab;document.querySelectorAll('[data-auth-tab]').forEach(x=>x.classList.remove('active'));el.classList.add('active');document.getElementById('authForm').innerHTML=authForm(authMode);bind();}));
    const authImportFile=document.getElementById('accountImportFile'); if(authImportFile&&!authImportFile.dataset.bound){authImportFile.dataset.bound='1';bindEvent(authImportFile,'change',e=>importAccountFile(e.target.files?.[0]));}
  }
  ...
  function action(name, el){
    ...
    if(name==='demo'){match3Runtime=null;auth={demo:true};state=clone(seed);safeJsonWrite(AUTH,auth);safeJsonWrite(STORAGE,state);persistAccount();go('dashboard');pullRemote().then(()=>{startLiveFamilyRefresh();render();}).catch(()=>{});}
    if(name==='exit-demo'){match3Runtime=null;localStorage.removeItem(AUTH);localStorage.removeItem(STORAGE);auth=null;state=clone(seed);go('landing');showToast('Демо завершено');}
    if(name==='logout'){logoutCurrentAccount();}
    if(['switch-user','new-quest','new-shop','accounts'].includes(name)){if(name==='accounts')document.body.classList.remove('menu-open');appendMarkup(document.body,modal(name));bindModal();}
    ...
    if(name==='close-menu'){document.body.classList.remove('menu-open');document.querySelector('.global-menu-trigger')?.focus();const trigger=document.querySelector('.global-menu-trigger');if(trigger)trigger.setAttribute('aria-expanded','false');}
    ...
    if(name==='room-theme-select')chooseRoomTheme(el?.dataset.level);
    ...
    if(name==='room-workshop-size')cycleRoomStudioSize();
    if(name==='room-workshop-top')scrollRoomWorkshopTop();
    ...
    if(name==='edit-profile'){appendMarkup(document.body,modal('edit-profile'));bindModal();}
    if(name==='manage-important-dates'){appendMarkup(document.body,modal('important-dates'));bindModal();}
    if(name==='add-important-date') addImportantDate();
    if(name==='leave-sticker') openStickerModal(el?.dataset.userId);
    if(name==='leave-family'){appendMarkup(document.body,modal('leave-family'));bindModal();}
    ...
    if(name==='invite'){appendMarkup(document.body,modal('invite'));bindModal();}
  ...
  function openNamedModal(name){const html=modal(name);if(!html)return;appendMarkup(document.body,html);bindModal();}
  const modalBoundNodes=new WeakSet();
  function bindModal(){
    document.querySelectorAll('.modal-backdrop').forEach(prepareModal);

    document.querySelectorAll('[data-close]').forEach(x=>bindEvent(x,'click',()=>{x.closest('.modal-backdrop')?.remove();modalReturnFocus?.focus?.();}));
    document.querySelectorAll('[data-select-user]').forEach(x=>bindEvent(x,'click',()=>{state.currentUserId=x.dataset.selectUser;save();document.querySelector('.modal-backdrop').remove();render();}));
    document.querySelectorAll('[data-account-id]').forEach(x=>bindEvent(x,'click',()=>switchAccount(x.dataset.accountId)));
    const importFile=document.getElementById('accountImportFile'); if(importFile)bindEvent(importFile,'change',e=>importAccountFile(e.target.files?.[0]));
    document.querySelectorAll('[data-send-sticker]').forEach(x=>bindEvent(x,'click',()=>sendSticker(x.dataset.to,x.dataset.sendSticker)));
    document.querySelectorAll('[data-delete-important-date]').forEach(x=>bindEvent(x,'click',()=>deleteImportantDate(x.dataset.deleteImportantDate)));
    document.querySelectorAll('.modal [data-action]').forEach(el=>{if(modalBoundNodes.has(el))return;modalBoundNodes.add(el);bindEvent(el,'click',()=>action(el.dataset.action,el));});
  }
  ...
  function exportLoginAccount(){
    ...
    const approved=confirm(tr('Швидкий JSON входу відкриває профіль без пароля. Людина, яка отримає цей файл, зможе увійти у ваш профіль. Зберегти файл?','The quick login JSON opens your profile without a password. Anyone with this file can sign in to your profile. Save the file?'));
    if(!approved)return;
  ...
  async function shareAccount(){
    ...
    appendMarkup(document.body,`<div class="modal-backdrop"><div class="modal"><div class="modal-head"><h2>Файл готовий</h2><button class="close" data-close>×</button></div><p>Натисніть кнопку нижче, щоб Android відкрив системне меню поширення. Друге натискання потрібне, щоб браузер не втрачав дозвіл користувача під час шифрування файлу.</p><div class="modal-actions wrap"><button class="btn primary" data-action="confirm-share-account">📤 Відкрити меню поширення</button><button class="btn" data-action="download-pending-account">⬇ Зберегти файл</button></div></div></div>`);
    bindModal();
  }
  ...
  async function grantCoins(){
    ...
    const diamonds=Math.trunc(Number(document.getElementById('grantDiamondsAmount')?.value||0));
    if(!userId||!Number.isFinite(amount)||!Number.isFinite(diamonds)||amount<0||diamonds<0||amount>1000000||diamonds>100000||(!amount&&!diamonds))return showToast('Вкажіть монети та/або кристали');
    try{
  ...
  function openResetSessionDialog(){ appendMarkup(document.body,modal('reset-session')); bindModal(); }
  function openResetUserDialog(userId){ appendMarkup(document.body,modal(`reset-user:${userId}`)); bindModal(); }
  ...
  function readQuestEditor(){return {title:(document.getElementById('qTitle')?.value||'').trim(),icon:(document.getElementById('qIcon')?.value||'✓').trim()||'✓',description:(document.getElementById('qDesc')?.value||'').trim(),type:document.getElementById('qType')?.value||'personal',difficulty:document.getElementById('qDifficulty')?.value||'normal',skill:document.getElementById('qSkill')?.value||'home',rewardCoins:Math.max(0,Number(document.getElementById('qCoins')?.value||0)),rewardDiamonds:Math.max(0,Number(document.getElementById('qDiamonds')?.value||0)),rewardXp:Math.max(0,Number(document.getElementById('qXp')?.value||0)),stage:document.getElementById('qStage')?.value||'Базовий',prerequisiteId:document.getElementById('qPrerequisite')?.value||''};}
  function saveEditedQuest(id){const q=state.quests.find(x=>x.id===id),v=readQuestEditor();if(!q||!v.title)return showToast('Вкажіть назву');Object.assign(q,v,{participants:v.type==='personal'||v.type==='limited'?1:2,skillXp:Math.max(0,Math.round(v.rewardXp/4))});if(q.catalog){state.questOverrides=state.questOverrides||{};state.questOverrides[q.id]={...v,skillXp:q.skillXp,status:q.status};}save();document.querySelector('.modal-backdrop')?.remove();render();showToast('Квест оновлено');}
  ...
  function readShopEditor(){return {title:(document.getElementById('sTitle')?.value||'').trim(),icon:(document.getElementById('sIcon')?.value||'✨').trim()||'✨',description:(document.getElementById('sDesc')?.value||'').trim(),type:document.getElementById('sType')?.value||'personal',price:Math.max(0,Number(document.getElementById('sPrice')?.value||0)),stock:Math.max(0,Number(document.getElementById('sStock')?.value||0)),durationDays:Math.max(1,Math.min(30,Number(document.getElementById('sDurationDays')?.value||7))),rewardKind:document.getElementById('sRewardKind')?.value||'permanent',resourceUrl:cleanResourceUrl(document.getElementById('sResourceUrl')?.value||'')||''};}
  ...
  function handleQuest(id){const q=state.quests.find(q=>q.id===id),u=currentUser();if(!q||!u)return;const status=questStatus(state,u,q);if(status.done||status.waiting)return;if(status.reason)return showToast(status.reason);return runGameAction(status.joined?'quest-complete':'quest-claim',{questId:id,day:localDay()});}
  function handleShop(id){return runGameAction('shop-buy',{itemId:id});}

  async function transferFamilyAdminRights(targetUserId){const target=state.users.find(u=>u.id===targetUserId);if(!target||!isAdmin())return;if(!confirm(tr('Передати права адміністратора ','Transfer admin rights to ')+target.name+'?'))return;return runGameAction('admin-transfer',{to:targetUserId});}
  ...
  function saveQuest(){const value=readQuestEditor();if(!value.title)return showToast('Вкажіть назву');state.quests.unshift({...value,id:crypto.randomUUID(),participants:['pair','coop'].includes(value.type)?2:1,claimedBy:[],progress:{},skillXp:Math.max(0,Math.round(value.rewardXp/4)),source:'admin',status:'active',limited:value.type==='limited',stock:value.type==='limited'?1:null});save();document.querySelector('.modal-backdrop')?.remove();render();}
  function saveShop(){const value=readShopEditor();if(!value.title)return showToast('Вкажіть назву');state.shop.unshift({...value,id:crypto.randomUUID(),fund:0,source:'admin'});save();document.querySelector('.modal-backdrop')?.remove();render();}

  function addImportantDate(){const u=currentUser(),day=Number(document.getElementById('importantDateDay')?.value),month=Number(document.getElementById('importantDateMonth')?.value),title=(document.getElementById('importantDateTitle')?.value||'').trim().slice(0,48);if(!u||!title||day<1||day>31||month<1||month>12)return showToast('Вкажіть правильну дату та назву');const check=new Date(2024,month-1,day);if(check.getMonth()!==month-1||check.getDate()!==day)return showToast('Такої дати не існує');u.importantDates=u.importantDates||[];if(u.importantDates.length>=20)return showToast('Можна додати до 20 важливих дат');u.importantDates.push({id:crypto.randomUUID(),day,month,title,visible:true});save();document.querySelector('.modal-backdrop')?.remove();appendMarkup(document.body,modal('important-dates'));bindModal();showToast('Дату додано');}
  function deleteImportantDate(id){const u=currentUser();if(!u)return;u.importantDates=(u.importantDates||[]).filter(x=>x.id!==id);save();document.querySelector('.modal-backdrop')?.remove();appendMarkup(document.body,modal('important-dates'));bindModal();showToast('Дату видалено');}
  ...
  function handleCosmetic(id){return runGameAction('cosmetic-buy',{itemId:id});}
  function claimLevelRewards(){return runGameAction('level-rewards');}
  async function contributeFamilyStyle(){const amount=Math.floor(Number(document.getElementById('familyStyleContribution')?.value||0));const result=await runGameAction('family-contribute',{amount});if(result)document.querySelector('.modal-backdrop')?.remove();}
  ...
  function openStickerModal(userId){appendMarkup(document.body,modal(`sticker:${userId}`));bindModal();}
  async function sendSticker(to,icon){const note=(document.getElementById('stickerNote')?.value||'').trim();const result=await runGameAction('profile-sticker',{to,stickerId:icon,note});if(result)document.querySelector('.modal-backdrop')?.remove();}
  async function openStickerBox(id){const result=await runGameAction('sticker-box',{boxId:id});if(result?.sticker)showStickerReveal(result.sticker,result.collection,result.isNew,result.dust,result.box);}
  async function exchangeStickerDust(collectionId){const result=await runGameAction('dust-exchange',{collectionId});if(result?.sticker)showStickerReveal(result.sticker,result.collection,true,0,null);}
  ...
  async function checkDailyRoulette(){
    ...
    try{
      ...
      if(info.available){appendMarkup(document.body,modal('daily-roulette'));bindModal();}
  ...
  async function spinDailyRoulette(){
    ...
    try{
      ...
      if(result.state)acceptServer(result);
  ...
  async function prepareOfflineApp(){
    ...
    try{
      ...
      const onMessage=event=>{
        ...
        if(data.type==='OFFLINE_PRELOAD_FAILED'){syncMessage='Частина ресурсів ще не готова офлайн';}
